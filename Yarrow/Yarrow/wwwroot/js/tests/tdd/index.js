...
var HtmlAttr = class {
  ...
  applyToElement(elem) {
    if (this.tags.length > 0 && this.tags.indexOf(elem.tagName) === -1) {
      let set3 = warnings.get(elem.tagName);
      if (!set3) {
        warnings.set(elem.tagName, set3 = /* @__PURE__ */ new Set());
      }
      if (!set3.has(this.key)) {
        set3.add(this.key);
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestOutputResultsEvent.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestCaseFailEvent.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestRunnerResultsEvent.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestStates.js
var TestStates;
(function(TestStates2) {
  TestStates2[TestStates2["found"] = 0] = "found";
  TestStates2[TestStates2["started"] = 1] = "started";
  TestStates2[TestStates2["succeeded"] = 2] = "succeeded";
  TestStates2[TestStates2["failed"] = 4] = "failed";
  TestStates2[TestStates2["completed"] = 8] = "completed";
})(TestStates || (TestStates = {}));

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestScore.js
var TestScore = class {
  constructor(name) {
    this.name = name;
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestRunner.js
...
function isTest(testCase, name) {
  return name.startsWith("test_") && isFunction(testCase[name]);
}
var TestRunner = class extends TypedEventTarget {
  constructor(...rest) {
    super();
    ...
    for (const CaseClass of this.CaseClasses) {
      for (const funcName of testNames(CaseClass.prototype)) {
        if (isTest(CaseClass.prototype, funcName)) {
          ...
          if ((isNullOrUndefined(testCaseName) || CaseClass.name === testCaseName) && (isNullOrUndefined(testName) || funcName === testName)) {
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestOutput.js
var TestOutput = class extends TypedEventTarget {
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestOutputHTML.js
function bar(c, w) {
  return [
    backgroundColor(c),
    color(c),
...
function refresher(thunk, ...rest) {
  return Button(onClick(thunk), gridColumn(1), "\u{1F504}\uFE0F", ...rest);
}
  ...
  constructor(...CaseClasses) {
    ...
    this.addEventListener("testoutputresults", (evt) => {
      const s = Math.round(100 * evt.stats.totalSucceeded / evt.stats.totalFound), f = Math.round(100 * evt.stats.totalFailed / evt.stats.totalFound), t2 = Math.round(100 * (evt.stats.totalFound - evt.stats.totalSucceeded - evt.stats.totalFailed) / evt.stats.totalFound), basicStyle = [
        ...
        overflow("hidden"),
        height(em(1))
      ], table = Div(display("grid"), gridTemplateColumns("auto", "auto", "auto", "auto", fr(1)), getMonospaceFamily(), width(perc(100)), columnGap(em(1)), refresher(() => this.run()), Div(gridColumn(2, -1), height(em(2)), whiteSpace("nowrap"), overflow("hidden"), Span(...basicStyle, ...bar("green", s)), Span(...basicStyle, ...bar("red", f)), Span(...basicStyle, ...bar("grey", t2))), Div(gridColumn(1), "Rerun"), Div(gridColumn(2, 4), "Name"), Div(gridColumn(4, -1), "Status"));
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestCaseMessageEvent.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestCaseSuccessEvent.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/testing/dist/tdd/TestCase.js
var TestCase = class extends TypedEventTarget {
  constructor() {
    super(...arguments);
  ...
  arraysMatch(actual, expected, message) {
    return this.twoValueTest(actual, "==", expected, (a, b) => a.length === b.length && a.map((v, i) => v === b[i]).reduce((a2, b2) => a2 && b2, true), message);
  }
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tslib/dist/blobToObjectURL.js
function blobToObjectURL(obj) {
  return new URL(URL.createObjectURL(obj));
}

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/fetcher/Fetcher.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/fetcher/index.js
var tests = [
  FetcherTests
];

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/hax/dist/copyProps.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/hax/dist/Hax.js
var Hax = class {
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/hax/dist/haxClass.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/hax/dist/haxMethod.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/hax/index.js
...
var BaseGraphNode = class {
  ...
  connectSorted(child, keySelector) {
    if (isDefined(keySelector)) {
      const comparer = compareBy((n2) => keySelector(n2.value));
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/collections/TreeNode.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/collections/index.js
var tests2 = [
  TreeNodeTests
];

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/events/once.js
...
var Rig = class extends TypedEventTarget {
  triggerGood() {
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/events/Task.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/events/TypedEventTarget.js
var Rig2 = class extends TypedEventTarget {
  triggerBubbles() {
...
var TypedEventTargetTests = class extends TestCase {
  setup() {
  }
  async test_Bubbles() {
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/events/index.js
var tests3 = [
  OnceTests,
  SuccessTests,
  TaskTests,
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/gis/dist/Datum.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/gis/dist/UTMPoint.js
var UTMPoint = class _UTMPoint {
  static centroid(points) {
    ...
    return new _UTMPoint().fromVec3(vec, maxZone).toLatLng().toUTM();
  }
  /**
  ...
  fromLatLng(latLng) {
    ...
    const A2 = _UTMPoint.A(cosPhi, latLng.lng, utmz);
    const Asqr = A2 * A2;
    const T = tanPhi * tanPhi;
    const C = DatumWGS_84.e0sq * cosPhi * cosPhi;
    const Tsqr = T * T;
  ...
  rezone(newZone) {
    ...
    if (newZone !== this.zone) {
      ...
      const width2 = _UTMPoint.getZoneWidthAtLatitude(ll.lat);
      return new _UTMPoint(this.easting - width2 * deltaZone, this.northing, this.altitude, newZone);
    } else {
      return this;
    }
  }
  ...
  clone() {
    return new _UTMPoint(this);
  }
};

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/gis/dist/LatLngPoint.js
var LatLngPoint = class _LatLngPoint {
  static centroid(points) {
    const scale3 = 1 / points.length;
    const vec = points.map((p) => p.toVec3()).reduce((a, b) => vec3_exports.scaleAndAdd(a, a, b, scale3), vec3_exports.create());
    return new _LatLngPoint().fromVec3(vec);
  }
  /**
  ...
  static parseDMSPair(value) {
    const parts = value.split(",");
    if (parts.length == 2) {
      const lat = _LatLngPoint.parseDMS(parts[0]);
      const lng = _LatLngPoint.parseDMS(parts[1]);
      if (!Number.isNaN(lat) && !Number.isNaN(lng)) {
        return new _LatLngPoint(lat, lng);
      }
    }
    return null;
  }
   ...
   **/
  static parse(value) {
    const asDecimal = _LatLngPoint.parseDecimal(value);
    const asDMS = _LatLngPoint.parseDMSPair(value);
  ...
  toDMS(sigfigs, withAltitude = true) {
    const latStr = _LatLngPoint.toDMS(this.lat, "S", "N", sigfigs);
    const lngStr = _LatLngPoint.toDMS(this.lng, "W", "E", sigfigs);
  ...
  toDMSArray(sigfigs, withAltitude = false) {
    const parts = [
      _LatLngPoint.toDMS(this.lat, "S", "N", sigfigs),
      _LatLngPoint.toDMS(this.lng, "W", "E", sigfigs)
    ];
    if (this.alt && withAltitude) {
  ...
  clone() {
    return new _LatLngPoint(this);
  }
};

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/gis/UTMPoint.js
var K = 1e-8;
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/gis/index.js
var tests4 = [
  UTMPointTests
];
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/URLBuilder.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/using.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/tslib/index.js
var tests5 = [
  ...tests2,
  ...tests3,
  ...tests4,
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tslib/dist/units/fileSize.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/units/fileSizes.js
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/units/index.js
var tests6 = [
  FileSizeTests
];

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/collections/binarySearch.js
var BinarySearchTests = class extends TestCase {
  test_AscendingSort() {
...
// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/collections/index.js
var tests7 = [
  BinarySearchTests
];

// ../../Juniper/src/Juniper.TypeScript/@juniper-lib/tests/dist/index.js
var tests8 = [
  ...tests7,
  haxTests,
  ...tests6,
