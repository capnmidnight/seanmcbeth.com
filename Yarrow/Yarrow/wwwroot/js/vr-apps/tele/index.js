...
function srcObject(value) {
  return new Attr("srcObject", value, false, "audio", "video");
}
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/tslib/BufferReaderWriter.ts
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/threejs/BufferReaderWriter.ts
...
function getPointerType(id) {
  switch (id) {
    ...
    case 4 /* Gamepad */:
      return "gamepad";
    case 5 /* MotionController */:
    case 6 /* MotionControllerLeft */:
    case 7 /* MotionControllerRight */:
      return "hand";
    case 8 /* Nose */:
      return "nose";
    case 9 /* RemoteUser */:
...
var PointerRemote = class extends BasePointer {
  constructor(avatar, env, remoteID) {
    ...
    super("remote", 9 /* RemoteUser */, env, cursor);
    this.avatar = avatar;
    ...
    this.object = obj(
      `remote:${this.avatar.userName}:${this.name}`,
  ...
  readState(buffer) {
    ...
    if (this.remoteID === 1 /* Mouse */ || this.remoteID === 3 /* Touch */) {
    ...
    if (5 /* MotionController */ <= this.remoteID && this.remoteID <= 7 /* MotionControllerRight */) {
  ...
  animate(dt) {
    ...
    this.M.copy(this.object.parent.matrixWorld).invert().multiply(this.MW).decompose(
      this.object.position,
      this.object.quaternion,
      this.object.scale
    );
...
var AvatarRemote = class {
  ...
  assurePointer(id) {
    ...
    if (!pointer) {
      ...
      if (id === 6 /* MotionControllerLeft */ || id === 7 /* MotionControllerRight */) {
        this.removePointersExcept(6 /* MotionControllerLeft */, 7 /* MotionControllerRight */);
      } else {
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/threejs/DebugObject.ts
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/webrtc/ConferenceEvents.ts
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/webrtc/ConnectionState.ts
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/webrtc/GainDecayer.ts
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/webrtc/RemoteUser.ts
var Locker = class {
  constructor() {
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/webrtc/TeleconferenceManager.ts
...
var TeleconferenceManager = class extends TypedEventBase {
  ...
  async connect() {
    await whenDisconnected("Connecting", () => this.connectionState, async () => {
      ...
      this.heartbeatTimer = setInterval(() => {
        if (this.hub.connectionState === "Connected" /* Connected */) {
  ...
  async forEachUser(callback) {
    if (this.conferenceState === "Connected" /* Connected */) {
      await Promise.all(
        Array.from(this.users.values()).map(callback)
      );
    }
  }
  async sendUserState(buffer) {
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/webrtc/IHub.ts
...
var hubStateTranslations = /* @__PURE__ */ new Map([
  [HubConnectionState.Connected, "Connected" /* Connected */],
  [HubConnectionState.Connecting, "Connecting" /* Connecting */],
  [HubConnectionState.Reconnecting, "Connecting" /* Connecting */],
  [HubConnectionState.Disconnected, "Disconnected" /* Disconnected */],
  [HubConnectionState.Disconnecting, "Disconnecting" /* Disconnecting */]
]);
var SignalRHub = class extends TypedEventBase {
