...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/threejs/menu/MenuItem.ts
...
// ../Juniper/src/Juniper.TypeScript/@juniper-lib/threejs/menu/Menu.ts
...
var Menu = class extends Object3D {
  ...
  async load(description, prog) {
    ...
    await progressTasksWeighted(prog, [
      ...
      [5, (prog2) => this.env.fetcher.assets(
        prog2,
        backButtonAsset,
        defaultButtonAsset,
        titleAsset,
  ...
  async showMenu(menuID, title2, items, onClick, onBack, prog) {
    ...
    await this.showMenuInternal(menuID, title2, items, pageSize, index, onClick, onBack, prog);
  }
  disableAll() {
    setTimeout(() => {
  ...
  async showMenuInternal(menuID, title2, items, pageSize, index, onClick, onBack, prog) {
    this.lastMenuIndex.set(menuID, index);
    await this.curBlowout;
    this.clear();
    this.menuTitle.text = title2;
    ...
    const onPrev = () => {
      this.disableAll();
      this.showMenuInternal(menuID, title2, items, pageSize, index - pageSize, onClick, onBack);
    };
    const onNext = () => {
      this.disableAll();
      this.showMenuInternal(menuID, title2, items, pageSize, index + pageSize, onClick, onBack);
...
var MainMenu = class extends Application {
  constructor(env) {
    super(env);
    this.node2MenuItem = /* @__PURE__ */ new Map();
    this.menuItem2Node = /* @__PURE__ */ new Map();
