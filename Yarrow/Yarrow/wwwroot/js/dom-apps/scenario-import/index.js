// ../Juniper/src/Juniper.TypeScript/@juniper-lib/dom/documentReady.ts
...
function ariaValueMax(value) {
  return new Attr("ariaValueMax", value, false);
}
function ariaValueMin(value) {
  return new Attr("ariaValueMin", value, false);
}
function ariaValueNow(value) {
  return new Attr("ariaValueNow", value, false);
}
...
function role(value) {
  return new Attr("role", value, false);
}
function type(value) {
  if (!isString(value)) {
    value = value.value;
