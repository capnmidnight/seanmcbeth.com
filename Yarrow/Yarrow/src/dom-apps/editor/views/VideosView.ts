import { autoComplete, classList, customData, max, min, placeHolder, step, value, wrap } from "@juniper-lib/dom/attrs";
import { onInput } from "@juniper-lib/dom/evts";
import { InputCheckbox, Option, Select, TextArea } from "@juniper-lib/dom/tags";
import { Video_Mp4, Video_Mpeg, Video_Webm } from "@juniper-lib/mediatypes";
import { SphereEncodingName, SphereEncodingNames, StereoLayoutName, StereoLayoutNames } from "@juniper-lib/threejs/VideoPlayer3D";
import { formatNumber, formatVolume, parseNumber, parseVolume } from "@juniper-lib/tslib/math";
