import { autoComplete, classList, customData, max, min, placeHolder, step, wrap } from "@juniper-lib/dom/attrs";
import { onInput } from "@juniper-lib/dom/evts";
import { InputCheckbox, TextArea } from "@juniper-lib/dom/tags";
import { Audio_Mpeg, Audio_Webm } from "@juniper-lib/mediatypes";
import { formatVolume, parseVolume } from "@juniper-lib/tslib/math";
