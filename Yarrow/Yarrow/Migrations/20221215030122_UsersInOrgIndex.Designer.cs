...
namespace Yarrow.Migrations
{
    ...
    [Migration("20221215030122_UsersInOrgIndex")]
    partial class UsersInOrgIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yarrow.Data.MenuItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "ScenarioId" }, "IX_MenuItems_ScenarioID");
            ...
            modelBuilder.Entity("Yarrow.Data.Scenario", b =>
                {
                    ...
                    b.HasIndex(new[] { "LanguageId" }, "IX_Scenarios_LanguageID");
            ...
            modelBuilder.Entity("Yarrow.Data.UsersInOrganization", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex(new[] { "OrganizationId" }, "IX_UsersInOrganization_OrganizationID");

                    b.ToTable("UsersInOrganization", (string)null);
                });
            ...
            modelBuilder.Entity("Yarrow.Data.UsersInOrganization", b =>
                {
                    b.HasOne("Yarrow.Data.Organization", "Organization")
                        .WithMany("UsersInOrganizations")
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_UsersInOrganization_Organizations");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "User")
                        .WithOne()
                        .HasForeignKey("Yarrow.Data.UsersInOrganization", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_UsersInOrganization_AspNetUsers");
            ...
            modelBuilder.Entity("Yarrow.Data.Organization", b =>
                {
                    b.Navigation("UsersInOrganizations");
                });
