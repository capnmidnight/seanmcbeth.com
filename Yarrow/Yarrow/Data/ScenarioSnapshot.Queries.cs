...
namespace Yarrow.Data
{
    ...
    {
        private ScenarioOutputFull MakeFullScenarioOutput(int? orgId, Scenario scenarioGroup, ScenarioSnapshot scenario)
        {
        ...
        private Task<Scenario> GetScenarioGroup(Expression<Func<Scenario, bool>> predicate) =>
            Scenarios
        ...
        private async Task<ScenarioSnapshot> DuplicateScenarioAsync(Scenario scenarioGroup, ScenarioSnapshot scenario, ScenarioOutputFull data, int version, string createdByUserId)
        {
            var scenarioCopy = new ScenarioSnapshot
            {
        ...
        private async Task SaveScenarioDataAsync(ScenarioSnapshot scenario, ScenarioOutputFull data, Func<int, File> mapFile)
        {
            ...
            await ScenariosSnapshots.AddAsync(scenario);
        ...
        public async Task<Scenario> DuplicateScenarioGroupAsync(int? orgId, int scenarioGroupID, string createdByUserId)
        {
            ...
            var scenarioGroupCopy = new Scenario
            {
            ...
            await Scenarios.AddAsync(scenarioGroupCopy);
        ...
        public async Task<ScenarioSnapshot> BumpScenarioVersionAsync(int? orgId, int scenarioID, string createdByUserId)
        {
            var scenarioGroup = await GetScenarioGroup(sg => sg.Scenarios.Any(s => s.Id == scenarioID));
            var scenario = scenarioGroup.Scenarios.FirstOrDefault(s => s.Id == scenarioID);
            var data = MakeFullScenarioOutput(orgId, scenarioGroup, scenario);
        ...
        public async Task<Scenario> ImportScenarioAsync(Stream zipStream, string createdByUserId)
        {
            ...
            var scenarioGroup = new Scenario
            {
                Name = scenarioName,
                CreatedById = createdByUserId
            };
        ...
        public async Task DeleteScenarioAsync(ScenarioSnapshot scenario)
        {
            ...
            ScenariosSnapshots.Remove(scenario);
