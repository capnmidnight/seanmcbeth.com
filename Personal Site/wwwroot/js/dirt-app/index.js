...
elementApply(document.body, elementApply(dirt, styles(touchAction("none")), onPointerMove(checkPointer), onPointerDown(checkPointer), onPointerCancel(checkPointer), onPointerUp(checkPointer), onPointerLeave(checkPointer), onPointerEnter(checkPointer), onPointerOut(checkPointer), onPointerOver(checkPointer)));
function checkPointer(evt) {
  if (!isModifierless(evt)) {
    ...
    dirt.checkPointer(evt.pointerId, evt.offsetX, evt.offsetY, type2);
  }
}
